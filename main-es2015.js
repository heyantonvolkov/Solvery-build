...
let SkillsTagListComponent = class SkillsTagListComponent {
    constructor() {
        this.skillTags = [];
    }
    ngOnInit() {
...
let SocialLinksListComponent = class SocialLinksListComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let MenteePageComponent = class MenteePageComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let MentorBaseInfoComponent = class MentorBaseInfoComponent {
    constructor() {
...
let MentorBioComponent = class MentorBioComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let MentorHeroBlockComponent = class MentorHeroBlockComponent {
    constructor() {
...
let MentorHireInfoComponent = class MentorHireInfoComponent {
    constructor() {
        this.priceList = [
            {
...
let MentorPhotoBlockComponent = class MentorPhotoBlockComponent {
    constructor() {
        this.socialLinks = [
            {
                name: 'github',
...
let MentorSkillsListComponent = class MentorSkillsListComponent {
    constructor() { }
    ngOnInit() {
        if (this.mentorProblemsToSolve.length) {
            this.filteredProblems = this.mentorProblemsToSolve.reduce((result, problem) => {
                result.push({
                    key: problem,
...
let MentorPageComponent = class MentorPageComponent {
    constructor() { }
    ngOnInit() {
    }
};
